    ...
    VisualRecognitionV3.prototype.createClassifier = function (params, callback) {
        ...
        positiveExampleClasses.forEach(function (positiveExampleClass) {
            if (!_params[positiveExampleClass + "_filename"]) {
                console.warn("WARNING: `" + positiveExampleClass + "_filename` should be provided if `" + positiveExampleClass + "` is not null. This will be REQUIRED in the next major release.");
            }
